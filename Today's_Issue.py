...
president_number, president = date_keyword_search("대통령비서실", "2022-11-10", "2022-11-10")
prime_number, prime = date_keyword_search("총리", "2022-11-10", "2022-11-10")
opm_number, opm = date_keyword_search("국무조정실", "2022-11-10", "2022-11-10")
moef_number, moef = date_keyword_search("기획재정부", "2022-11-10", "2022-11-10")
moe_number, moe = date_keyword_search("교육부", "2022-11-10", "2022-11-10")
msit_number, msit = date_keyword_search("과학기술정보통신부", "2022-11-10", "2022-11-10")
mofa_number, mofa = date_keyword_search("외교부", "2022-11-10", "2022-11-10")
unikorea_number, unikorea = date_keyword_search("통일부", "2022-11-10", "2022-11-10")
moj_number, moj = date_keyword_search("법무부", "2022-11-10", "2022-11-10")
mnd_number, mnd = date_keyword_search("국방부", "2022-11-10", "2022-11-10")
mois_number, mois = date_keyword_search("행정안전부", "2022-11-10", "2022-11-10")
mcst_number, mcst = date_keyword_search("문화체육관광부", "2022-11-10", "2022-11-10")
mafra_number, mafra = date_keyword_search("농림축산식품부", "2022-11-10", "2022-11-10")
motie_number, motie = date_keyword_search("산업통상자원부", "2022-11-10", "2022-11-10")
mohw_number, mohw = date_keyword_search("보건복지부", "2022-11-10", "2022-11-10")
me_number, me = date_keyword_search("환경부", "2022-11-10", "2022-11-10")
moel_number, moel = date_keyword_search("고용노동부", "2022-11-10", "2022-11-10")
mogef_number, mogef = date_keyword_search("여성가족부", "2022-11-10", "2022-11-10")
molit_number, molit = date_keyword_search("국토교통부", "2022-11-10", "2022-11-10")
mof_number, mof = date_keyword_search("해양수산부", "2022-11-10", "2022-11-10")
mss_number, mss = date_keyword_search("중소벤처기업부", "2022-11-10", "2022-11-10")
mpva_number, mpva = date_keyword_search("국가보훈부", "2022-11-10", "2022-11-10")
ftc_number, ftc = date_keyword_search("공정거래위원회", "2022-11-10", "2022-11-10")
fsc_number, fsc = date_keyword_search("금융위원회", "2022-11-10", "2022-11-10")
acrc_number, acrc = date_keyword_search("국민권익위원회", "2022-11-10", "2022-11-10")
pipc_number, pipc = date_keyword_search("개인정보보호위원회", "2022-11-10", "2022-11-10")
nssc_number, nssc = date_keyword_search("원자력안전위원회", "2022-11-10", "2022-11-10")
kcc_number, kcc = date_keyword_search("방송통신위원회", "2022-11-10", "2022-11-10")
mpm_number, mpm = date_keyword_search("인사혁신처", "2022-11-10", "2022-11-10")
moleg_number, moleg = date_keyword_search("법제처", "2022-11-10", "2022-11-10")
mfds_number, mfds = date_keyword_search("식품의약품안전처", "2022-11-10", "2022-11-10")
