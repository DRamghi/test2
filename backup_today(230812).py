...
prime_pos, prime_neg, prime_neu, prime = department_search("총리")
...
n = 1
for name, number, departments in zip(name_list, number_list, department_list):
    if number > 0 :
        n = n + 1
        if n % 2 == 0:
            with col1:
